    ...
    public class SampleData : DropCreateDatabaseIfModelChanges<WeddingEntity>
    {
        protected override void Seed(WeddingEntity context)
        {
            ...
            var shangpin = new List<Prouduct>
            {
               ...
               new Prouduct { LeiBie = leiBies.Single(g => g.Name == "观赏性绿色植物"),Varieties="观赏性绿色植物",IsNew="N",Title="想编自己编。" ,Price=58.00m,TuPian="/Content/green/1.jpg"},
               new Prouduct { LeiBie = leiBies.Single(g => g.Name == "观赏性绿色植物"),Varieties="观赏性绿色植物",IsNew="N",Title="想编自己编。" ,Price=69.00m,TuPian="/Content/green/2.jpg"},
               new Prouduct { LeiBie = leiBies.Single(g => g.Name == "观赏性绿色植物"),Varieties="观赏性绿色植物",IsNew="N",Title="想编自己编。" ,Price=39.00m,TuPian="/Content/green/3.jpg"},
               new Prouduct { LeiBie = leiBies.Single(g => g.Name == "观赏性绿色植物"),Varieties="观赏性绿色植物",IsNew="Y",Title="想编自己编。" ,Price=59.00m,TuPian="/Content/green/4.jpg"},
               new Prouduct { LeiBie = leiBies.Single(g => g.Name == "观赏性绿色植物"),Varieties="观赏性绿色植物",IsNew="N",Title="想编自己编。" ,Price=38.00m,TuPian="/Content/green/5.jpg"},
               new Prouduct { LeiBie = leiBies.Single(g => g.Name == "观赏性绿色植物"),Varieties="观赏性绿色植物",IsNew="N",Title="想编自己编。" ,Price=49.00m,TuPian="/Content/green/6.jpg"},
