    ...
    public class SampleData : DropCreateDatabaseIfModelChanges<FlowersEntity>
    {
        protected override void Seed(FlowersEntity context)
        {
            ...
            var leiBies = new List<LeiBie>
            {
                ...
                new LeiBie { LeiBieId=7,Name = "绿色植物",TypeId=2,Description="绿了绿了，全都绿起来了呢" },
            ...
            var shangpin = new List<Prouduct>
            {
               ...
               new Prouduct { LeiBie = leiBies.Single(g => g.Name == "绿色植物"),Varieties="绿色植物",IsNew="N",Title="想编自己编。" ,Price=58.00m,TuPian="/Content/green/1.jpg"},
               new Prouduct { LeiBie = leiBies.Single(g => g.Name == "绿色植物"),Varieties="绿色植物",IsNew="N",Title="想编自己编。" ,Price=69.00m,TuPian="/Content/green/2.jpg"},
               new Prouduct { LeiBie = leiBies.Single(g => g.Name == "绿色植物"),Varieties="绿色植物",IsNew="N",Title="想编自己编。" ,Price=39.00m,TuPian="/Content/green/3.jpg"},
               new Prouduct { LeiBie = leiBies.Single(g => g.Name == "绿色植物"),Varieties="绿色植物",IsNew="Y",Title="想编自己编。" ,Price=59.00m,TuPian="/Content/green/4.jpg"},
               new Prouduct { LeiBie = leiBies.Single(g => g.Name == "绿色植物"),Varieties="绿色植物",IsNew="N",Title="想编自己编。" ,Price=38.00m,TuPian="/Content/green/5.jpg"},
               new Prouduct { LeiBie = leiBies.Single(g => g.Name == "绿色植物"),Varieties="绿色植物",IsNew="N",Title="想编自己编。" ,Price=49.00m,TuPian="/Content/green/6.jpg"},
               new Prouduct { LeiBie = leiBies.Single(g => g.Name == "绿色植物"),Varieties="绿色植物",IsNew="Y",Title="想编自己编。" ,Price=569.00m,TuPian="/Content/green/7.jpg"},
               new Prouduct { LeiBie = leiBies.Single(g => g.Name == "绿色植物"),Varieties="绿色植物",IsNew="N",Title="想编自己编。" ,Price=59.00m,TuPian="/Content/green/8.jpg"},
               new Prouduct { LeiBie = leiBies.Single(g => g.Name == "绿色植物"),Varieties="绿色植物",IsNew="N",Title="想编自己编。" ,Price=239.00m,TuPian="/Content/green/9.jpg"},
               new Prouduct { LeiBie = leiBies.Single(g => g.Name == "绿色植物"),Varieties="绿色植物",IsNew="N",Title="想编自己编。" ,Price=89.00m,TuPian="/Content/green/10.jpg"},
               new Prouduct { LeiBie = leiBies.Single(g => g.Name == "绿色植物"),Varieties="绿色植物",IsNew="N",Title="想编自己编。" ,Price=99.00m,TuPian="/Content/green/10.jpg"},
               new Prouduct { LeiBie = leiBies.Single(g => g.Name == "绿色植物"),Varieties="绿色植物",IsNew="Y",Title="想编自己编。" ,Price=99.00m,TuPian="/Content/green/11.jpg"},
               new Prouduct { LeiBie = leiBies.Single(g => g.Name == "绿色植物"),Varieties="绿色植物",IsNew="N",Title="想编自己编。" ,Price=99.00m,TuPian="/Content/green/12.jpg"},
               new Prouduct { LeiBie = leiBies.Single(g => g.Name == "绿色植物"),Varieties="绿色植物",IsNew="N",Title="想编自己编。" ,Price=99.00m,TuPian="/Content/green/13.jpg"},
               new Prouduct { LeiBie = leiBies.Single(g => g.Name == "绿色植物"),Varieties="绿色植物",IsNew="N",Title="想编自己编。" ,Price=99.00m,TuPian="/Content/green/14.jpg"},
               new Prouduct { LeiBie = leiBies.Single(g => g.Name == "绿色植物"),Varieties="绿色植物",IsNew="Y",Title="想编自己编。" ,Price=99.00m,TuPian="/Content/green/15.jpg"},
